const translations = {
  pt: {
    ...
    ai_processing_subtitle: 'Nossa IA está criando a melhor descrição',
    ai_processing_analyzing: 'Analisando imagens',
    ai_processing_category: 'Identificando categoria',
    ai_processing_description: 'Gerando descrição',
    ai_processing_price: 'Sugerindo preço',

    product_review_title: 'Revisar Produto',
    product_review_subtitle: 'Confira e ajuste as informações',
    product_review_title_label: 'Título',
    product_review_description_label: 'Descrição',
    product_review_category_label: 'Categoria',
    product_review_price_label: 'Preço',
